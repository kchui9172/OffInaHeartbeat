...
@SuppressLint("NewApi")
public class ConnectH7  extends Thread{
    ...
    public ConnectH7(BluetoothDevice device, MainActivity ac) {
        Log.i("ConnectH7", "Starting H7 reader BTLE");
        this.ac=ac;
    ...
    public void cancel() {
        ...
        gat.disconnect();
        gat.close();
        Log.i("ConnectH7", "Closing HRsensor");
    }
    ...
    private final BluetoothGattCallback btleGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, final BluetoothGattCharacteristic characteristic) {
            ...
            Log.v("ConnectH7", "Data received from HR "+bmp);
        }
        ...
        public void onConnectionStateChange(final BluetoothGatt gatt, final int status, final int newState) {
            ...
            {
                Log.e("ConnectH7", "device Disconnected");
                //ac.connectionError();
            }
            else{
                gatt.discoverServices();
                Log.d("ConnectH7", "Connected and discovering services");
            }
        }
        ...
        public void onServicesDiscovered(final BluetoothGatt gatt, final int status) {
            ...
            for (BluetoothGattCharacteristic cc : characteristics)
            {
                for (BluetoothGattDescriptor descriptor : cc.getDescriptors()) {
                    ...
                    ConnectH7.descriptor=descriptor;
                    ConnectH7.cc=cc;
